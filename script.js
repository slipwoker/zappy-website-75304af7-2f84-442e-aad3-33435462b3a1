document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (field && validationRules[field.name]) {
                validateField(field);
            }
        });
        ...
        function showFormMessage(type, message) {
            var existingMessage = contactForm.querySelector('.form-message');
            if (existingMessage) {
    ...
    // CSS for animations (injected if not present)
    if (animatedElements.length > 0 && !document.getElementById('scroll-animation-styles')) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '75304af7-2f84-442e-aad3-33435462b3a1',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '75304af7-2f84-442e-aad3-33435462b3a1';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '75304af7-2f84-442e-aad3-33435462b3a1';
